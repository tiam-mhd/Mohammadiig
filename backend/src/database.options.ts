...
const migrations = [CreateProducts1710000000000, CreateProductCategories1710000001000, CreateUsersCustomers1710000002000, CreateQuotations1710000003000, CreateOrders1710000004000, CreateInvoicesPayments1710000005000, CreateProjectsServices1710000006000, CreateAttachments1710000007000, CreateProductExtensions1710000008000, CreateOrderCustomizations1710000009000];
...
export const databaseDataSourceOptions: DataSourceOptions = usePostgres
  ? {
      ...
      entities: [ProductEntity, CategoryEntity, UserEntity, CustomerEntity, QuotationEntity, OrderEntity, OrderItemEntity, OrderCustomizationEntity, InvoiceEntity, PaymentEntity, ProjectEntity, ProjectPhaseEntity, ServiceEntity, AttachmentEntity, ProductVariantEntity, ProductSpecificationEntity, SparePartEntity],
      migrations,
    }
  : {
      type: 'better-sqlite3',
